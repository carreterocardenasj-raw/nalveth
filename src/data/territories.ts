...
// porque usan URLs planas por diseño (ver ../.claude/docs/clusters/verifactu.md y ../.claude/docs/clusters/whatsapp.md).
//
...
export const TERRITORIES: Territory[] = [
  ...
  // esta lista. Añadirlo aquí también duplicaría el enlace. Ver ../.claude/docs/decisions.md, 2026-09-15.
];
