...
- **Cifra exacta del cobro por token de Meta Business Agent** (circula "2 USD/millón de tokens" en fuentes de terceros) — no confirmada en el texto navegable de la documentación oficial de Meta; existe un PDF vinculado ("Guía de precios de Meta Business Agent") sin abrir/verificar todavía.

## 11. Auditoría post-publicación (15/09/2026) y correcciones aplicadas

Tras publicar el clúster se ejecutó una auditoría destructiva completa (sin cambios) y, a continuación, se aplicaron únicamente las correcciones marcadas como obligatorias:

1. **Meta Business Agent**: la auditoría detectó que `/precio-whatsapp-business-api/` no mencionaba Meta Business Agent (producto propio de Meta, agente de IA nativo en WhatsApp/Messenger/Instagram) ni su cambio de precios ya vigente desde el **1 de agosto de 2026** (cobro por token, distinto de las tarifas normales de plantillas). Se añadió una sección específica, distinguiendo explícitamente el cambio del 1/08/2026 (ya vigente) del cambio del 1/10/2026 (todavía no vigente, mensajes de servicio/utilidad normales). La cifra de "2 USD/millón de tokens" que circula en fuentes de terceros se marca `[NO CONFIRMADO]` — no se ha verificado en el texto navegable de la documentación oficial de Meta. Fuente: página oficial "Próximas actualizaciones de precios para Meta Business Agent, servicios y mensajes de utilidad" (developers.facebook.com, actualizada 25/08/2026), verificada el 15/09/2026.
2. **Canibalización con `/ia-para-negocios/guias/que-es-agente-ia-whatsapp/`**: esa guía (ya publicada, sin tocar) queda como la pieza de referencia para "qué es un agente de IA / diferencia con chatbot". Se recortó la re-explicación conceptual en `/whatsapp/` (sustituida por un enlace contextual) y en `/automatizar-whatsapp/` (se mantuvo el criterio práctico de "cuándo tiene sentido un agente", pero se enlaza a la guía antigua para la explicación conceptual completa, en vez de repetirla).
3. **HubSpot**: la auditoría detectó que el precio citado era de Marketing Hub mientras el texto recomendaba la herramienta a "equipos comerciales". Se corrigió a **Sales Hub** (verificado el 15/09/2026 en hubspot.com/pricing/sales: Free 0$, Starter desde 7$/mes/asiento —promo, base 20$/mes/asiento—, Professional desde 90$/mes/asiento —promo, base 100$/mes/asiento—, Enterprise desde 150$/mes/asiento), con nota explícita de que HubSpot vende Marketing Hub y Service Hub aparte, sin mezclar características.
